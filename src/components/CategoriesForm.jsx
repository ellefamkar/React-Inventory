...
function CategoryForm({ setCategories }) {
  ...
  // ma ino dashtim inja ama liftup kardim chon ba categories jahaye dige kar darrim
  // pas inja faghat set mikonim category ke sakhte shode
  // categories khodesho ham niaz nis az prevState estefade mkonim ke khodesh dare
  // daroni azash mikhone

  const addNewCategoryHandler = (e) => {
    e.preventDefault();

    // because it is an array of object 
